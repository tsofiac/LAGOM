...
python preprocessing/NEW_preprocessing_all.py  # <-- här skriver ni bara namnet på ert script efter "python". NOTERA: detta script måste ligga i samma directory som python scriptet!!
