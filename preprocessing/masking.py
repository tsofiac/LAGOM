...
# ----------------------------------------------
def mask_dataset(csv_file, mask_prob, masked_file, masker_type, n_masked_sets, annotated=False):
...
if __name__ == "__main__":
    ...
    mask_dataset(csv_file, mask_prob, masked_file, masker_type, n_masked_sets, annotated)
